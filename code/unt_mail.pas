...
uses
  ...
  StdCtrls,ShellAPI, ComCtrls, ExtCtrls, ToolWin, Menus, Printers, IdAttachment,
  OleCtrls, SHDocVw, UHTMLabel;
...
begin
    ...
    begin
        ...
        begin
            if (TIdAttachment(dm_main.mail_message.MessageParts.Items[iAttachCount]).Filename = frm_mail.lv_attachment.Selected.SubItems[0]) then
            begin
