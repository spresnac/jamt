...
uses
  ...
  Menus,ImgList, IdBaseComponent, IdSocks,
  IdComponent, IdTCPConnection, IdTCPClient,
  IdMessageClient, IdPOP3, IdMessage, IdExplicitTLSClientServerBase,
  IdCustomTransparentProxy, IdIOHandler, IdIOHandlerSocket,
  IdIOHandlerStack;
