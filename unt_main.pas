...
type
  Tfrm_main = class(TForm)
    ...
    pnl_treeview: TPanel;
    tv_main: TTreeView;
    pnl_toolbarandadvertiser: TPanel;
    btn_getlist: TBitBtn;
    btn_deletemails: TBitBtn;
    btn_firewall: TBitBtn;
    btn_accounts: TBitBtn;
    btn_language: TBitBtn;
    btn_markall: TBitBtn;
...
begin
    ...
    if (AppComment = '') then
         frm_main.Caption     := AppName + ' ' + AppVersion
    else
         frm_main.Caption     := AppName + ' ' + AppVersion + ' - ' + AppComment;
    ...
    // Create a IniFile Stream and read the jamt.ini
...
begin
    ...
    begin
        ...
        begin
            ...
            frm_main.lv_main.Items[0].SubItems.Add(dm_main.mail_message.From.Text);
            frm_main.lv_main.Items[0].SubItems.Add(dm_main.mail_message.Subject);
...
procedure Tfrm_main.Splitter1Moved(Sender: TObject);
begin
     // When Splitter is moved, also resize the Status Bar Panel 0
    sb_main.Panels[0].Width     := pnl_treeview.Width;
end;
