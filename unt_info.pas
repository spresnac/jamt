...
type
  Tfrm_info = class(TForm)
    ...
    procedure lbl_ciaolinkClick(Sender: TObject);
...
begin
    cls_globals.labellink(self,'http://jamt.techcrawler.de/');
end;
...
procedure Tfrm_info.lbl_ciaolinkClick(Sender: TObject);
begin
    cls_globals.labellink(self,'http://www.ciao.com/product.php?ProduktId=976382');
end;
